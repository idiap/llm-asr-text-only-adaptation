...
#   - Added the text-only adaptation configuration (TextAdaptationConfig,
#     use_text_only_adaptation, train_aux_data_path)
...
@dataclass
class TextAdaptationConfig:
    tau_t: float = 0.5
    tau_a: float = 0
    sigma_a: Optional[float] = None
    sigma_ta: Optional[float] = None
    sigma_t: Optional[float] = None
    noise_type: str = "naive"  # "naive", "random", "echo", "empty"
...
class TrainConfig:
    ...
    use_text_only_adaptation:  Optional[bool] = False
    text_only_adaptation_config: TextAdaptationConfig = field(default_factory=TextAdaptationConfig)
...
class DataConfig:
    ...
    train_aux_data_path: Optional[str] = None
    ...
    # Parameters for Text-Only Adaptation
    use_text_only_adaptation: Optional[bool] = False
    text_only_adaptation_config: TextAdaptationConfig = field(default_factory=TextAdaptationConfig)
