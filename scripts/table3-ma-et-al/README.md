...
```bash
TARGET_DOMAIN=agriculture bash scripts/table3-ma-et-al/run_all.sh
TARGET_DOMAIN=animation bash scripts/table3-ma-et-al/run_all.sh
TARGET_DOMAIN=musical_instruments bash scripts/table3-ma-et-al/run_all.sh
```
...
```bash
TARGET_DOMAIN=agriculture bash scripts/table3-ma-et-al/decode_all.sh
TARGET_DOMAIN=animation bash scripts/table3-ma-et-al/decode_all.sh
TARGET_DOMAIN=musical_instruments bash scripts/table3-ma-et-al/decode_all.sh
```

Each decoded checkpoint writes its own `WER.txt`:

```
exp/table3/TOA/prompt_llama/<domain>_ma_et_al/<checkpoint>/WER.txt
```
